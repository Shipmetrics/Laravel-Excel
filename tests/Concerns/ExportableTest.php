...
class ExportableTest extends TestCase
{
    /**
     * @test
     * @expectedException \Maatwebsitevthree\Excel\Exceptions\NoFilenameGivenException
    ...
    /**
     * @test
     * @expectedException \Maatwebsitevthree\Excel\Exceptions\NoFilePathGivenException
